...
// OAuth2
#define COCOAPODS_POD_AVAILABLE_OAuth2
#define COCOAPODS_VERSION_MAJOR_OAuth2 0
#define COCOAPODS_VERSION_MINOR_OAuth2 1
#define COCOAPODS_VERSION_PATCH_OAuth2 0
